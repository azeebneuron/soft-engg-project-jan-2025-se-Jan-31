    ...
    <div class="dashboard-content">
      ...
      <div class="dashboard-card add-deadline-card">
        ...
        <form @submit.prevent="addDeadline" class="add-deadline-form">
          ...
          <input v-model="newDeadline.link" type="url" id="link" placeholder="Add a resource link" class="custom-input" /> -->
...
export default {
  data() {
    return {
      ...
      newDeadline: {
        course: "",
        title: "",
        date: this.getCurrentDate(), // Set default date to current date
        link: "",
        status: "not-started"
      },
    };
  ...
  created() {
    // Set the initial date to current date when component is created
